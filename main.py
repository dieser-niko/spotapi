...
def by_name(operation_type: str, operation_name: str, variables: dict):
    ...
    response = session.post(f"https://api-partner.spotify.com/pathfinder/v2/{operation_type}", json=item, headers=headers)
...
if __name__ == "__main__":
    a = by_name("query", "home", {"facet": "", "sectionItemsLimit": 10, "sp_t": "07f6a0ea0c1deea7f895536b0e09cd88", "timeZone": "Europe/Berlin"})
    print(a)